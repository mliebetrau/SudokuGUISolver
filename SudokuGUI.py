######################################################
## File Name: SudokuGUI.py                          ##
## Description: Simple SudokuGUI                    ##
######################################################
import pygame
import time
pygame.font.init()
...
class Cube:
    ...
    def draw(self, win):
        ...
        if self.selected: pygame.draw.rect(win, (255, 0, 0), (x, y, gap, gap), 3)
...
def main():
    ...
    while run:
        ...
        redrawWindow(window, board, playTime, strikes)
        pygame.display.update()
